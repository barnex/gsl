...
func main() {
	...
	for _,f:=range fs{fmt.Println(f)}	
...
func(*Dta)Make(typ string)string{
	switch typ{
		default: log.Fatal("canot make ", typ)
		case "int": return "1"
		case "complex128":return "complex128(1)"
		case "[]complex128":return "make([]complex128, N)"
		case "[][]complex128":return "MakeComplex128Matrix(N, N)"
		case "complex64":return "complex64(1)"
		case "[]complex64":return "make([]complex64, N)"
		case "[][]complex64":return "MakeComplex64Matrix(N, N)"
		case "float32":return "float32(1)"
		case "[]float32":return "make([]float32, N)"
		case "[][]float32":return "MakeFloat32Matrix(N, N)"
		case "float64":return "float64(1)"
		case "[]float64":return "make([]float64, N)"
		case "[][]float64":return "MakeFloat64Matrix(N, N)"
		case "Transpose": return "NoTrans"
		case "Uplo": return "Upper"
		case "Diag": return "NonUnit"
...
func noPkg(s string)string{
	if strings.HasPrefix(s, "blas."){return s[len("blas."):]}else{return s}
}
